                    ...
                    <Tabs
                        ...
                        <Tab eventKey="overview" title="Results">
                            <section id="overview">
                                ...
                                <p>We developed Toehold Switches using the NUPACK nucleic acid sequence design package (Version 4.0). Initially, Dr. José Barboza-Corona provided a template script in NUPACK Version 3.0, which we modified to Version 4.0 syntax for execution in a Jupyter Notebook environment. Our <a href="https://github.com/zealousplatypus/iGEM" target="_blank" rel="noreferrer">additional code</a>, was designed to create multiple switches from a single antibiotic resistance gene, which we synthesized and tested in laboratory settings. The process involves specifying switch generation conditions, defining variables, and structuring domains, switches, and complexes based on established designs. Each iteration of the code produces test tubes containing trigger-switch complexes, allowing individual switch activity assessment. We implemented a Crosstalk tube to enforce distinctiveness among generated switches and applied constraints, including specific gene subsections in trigger sequences and prevention of repetitive nucleotide runs. To adapt the switches for different genes, users can modify the constraining gene sequence and the number of switches generated as needed.<br></br><br></br>
