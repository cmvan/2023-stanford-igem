                    ...
                    <Tabs
                        ...
                        <Tab eventKey="overview" title="Overview">
                            <section id="overview">
                                ...
                                <p>SIBRP is a testament to our dedication to nurture the next generation of bioengineers. Through educational initiatives, mentorship, and a commitment to inclusivity, we inspire and empower young minds to explore the possibilities of synthetic biology and bioengineering. Lastly, Stanford iGEM would like to thank the <b>BioE Department's JEDI group</b> for sponsoring SIBRP.</p>
                        ...
                        <Tab eventKey="game" title="Phil's Laberia">
                            <section id="game">
                                <h2 className="content-section" id="phil-1"> Game Concept </h2>
                                <p>The initial concept for Phil’s Laberia was inspired by popular online cooking games. In many cooking games, you are assigned a task to create a dish by adding ingredients together and utilizing kitchen appliances to chop, bake, grill, or fry things. Similarly, in a lab setting, you combine reagents and utilize lab equipment to make even cooler things happen! Reflective of these similarities, Phil’s Laberia was named after Dr. Phil Kyriakakis, one of Stanford iGEM’s faculty mentors this year and the popular cooking game “Papa’s Pizzeria.” Instead of a pizzeria, however, the game takes place in a lab based on the Uytengsu Teaching Lab (UTL) at Stanford. When playing the game, individuals can choose what kind of “recipe” they want to follow, or in this case, what kind of lab protocol to conduct. Then, players can move around the lab, collect items, and conduct cool experiments! </p>
                                <div className="full-photos"><img className="large-photo" src="https://static.igem.wiki/teams/4951/wiki/education/levels.png" alt="Different Levels Currently in Game"></img><p class="caption">Different Levels Currently in Game</p></div>
                                <p>Version 1.0 of the game offers 9 different levels: the Lab Tour, DNA Extraction, PCR, Gel Electrophoresis, Gibson Assembly, Plated E.coli, Liquid Culture, Transformation, and Miniprep. These protocols utilize over 80+ materials or items that were added to the game. The usage of a pixel artstyle allowed for the game art to be made efficiently while maintaining a colorful palette. Below is a sprite sheet of some reagents in the game currently. </p>
                                <div className="full-photos"><img className="large-photo" src="https://static.igem.wiki/teams/4951/wiki/education/labmaterials.png" alt="Lab Reagents and Materials for Game"></img><p class="caption">Sprite Sheet for Lab Reagents and Materials</p></div>
                                ...
                                <div className="full-photos"><img className="large-photo" src="https://static.igem.wiki/teams/4951/wiki/education/ezgif-com-optimize-2.gif" alt="Gif of Character Walking"></img><p class="caption">Gif of Player Movement</p></div>
                                ...
                                <div className="full-photos"><img className="large-photo" src="https://static.igem.wiki/teams/4951/wiki/education/ezgif-com-video-to-gif.gif" alt="Winning the DNA Extraction Level"></img><p class="caption">Winning the DNA Extraction Level</p></div>
                                ...
                                <div className="full-photos"><img className="large-photo" src="https://static.igem.wiki/teams/4951/wiki/education/labtilesheet.png" alt="Tile Sheet for Game"></img><p class="caption">Tile Sheet for Game Map Outline and Machines</p></div>
